<div class="form-control-static">
    <table class="table-condensed">
        <tr>
            <td>Código</td>
            <td>: <input  id="addCodigo" onblur="validaCodigoProducto(this.value)" placeholder="Ej: 2345-4"/></td>
        </tr>
        <tr>
            <td>Nombre</td>
            <td>: <input id="addNombre" placeholder="Ej: Alarma"/></td>
        </tr>
        <tr>
            <td>Descripción</td>
        ...
        <tr>
            <td>responsable</td>
            <td>: <input id="addResponsable" disabled="true" /></td>
        </tr>
        <tr>
            <td>fecha</td>
